...
- (void)setupFilterBar {
    ...
    NSArray *dataSource = @[@"无",@"灰度",@"颠倒",@"马赛克",@"马赛克2",@"马赛克3", @"分屏_2",@"分屏_3",@"分屏_4",@"分屏_6",@"分屏_9"];
...
- (void)filterInit {
    ...
    //6.获取处理的图片路径
    NSString *imagePath = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"basketball.jpg"];
